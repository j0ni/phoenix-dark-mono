...
(custom-theme-set-faces
 ...
 '(js2-warning-face ((t (:foreground "#dfdfdf"))))
 '(js2-error-face ((t (:foreground "#efefef"))))
 '(js2-jsdoc-tag-face ((t (:foreground "#585858"))))
 '(js2-jsdoc-type-face ((t (:foreground "#787878"))))
 '(js2-jsdoc-value-face ((t (:foreground "#787878"))))
 '(js2-function-param-face ((t (:foreground "#bbb"))))
 '(js2-external-variable-face ((t (:foreground "#fff"))))
